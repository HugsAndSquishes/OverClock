...
export default function EditUserPage({ params }) {
  ...
  return (
    <ModelForm
      modelName="User"
      apiUrl={`${process.env.NEXT_PUBLIC_API_URL}/users/`}
      redirectUrl="/admin-dashboard/employee-management"
      ...
      fields={[
        ...
        { 
          ...
          label: 'Department', 
          type: 'select',
          optionsUrl: `${process.env.NEXT_PUBLIC_API_URL}/departments/`,
          displayField: 'name',
          required: false
        },
        // If creating a new user, add password field
