            ...
            <div className="p-8 w-full max-w-md mx-4 bg-gray-700 rounded-2xl shadow-xl border border-gray-600">
                <div className="space-y-6">
                    ...
                    <div className="text-center">
                        <h2 className={`text-3xl font-bold ${isClockedIn ? "text-green-400" : "text-gray-100"
                            }`}>
                    ...
                    >
                        <button
                            onClick={handleClock}
                            className={`w-full py-4 px-6 text-lg font-semibold rounded-xl transition-all duration-300 transform hover:shadow-lg ${isClockedIn
